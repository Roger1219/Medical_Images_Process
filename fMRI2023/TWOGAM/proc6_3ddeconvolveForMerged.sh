...
for patientName in $patientList
    do
        ...
        maskWD=$patientWD/mni152Space/mergeFEF
        ...
        for maskName in $(ls $maskWD |grep .nii)
            do
                ...
                3dDeconvolve -force_TR 2.4 -input $patientWD/mni152Space/mean1D/epi01_$extractMaskName.1D\' $patientWD/mni152Space/mean1D/epi02_$extractMaskName.1D\'     \
                             -jobs 10                                            \
                             -polort A                                           \
